...
<head>
    ...
    <title>Bj Education | Dashboard</title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Bj Education</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.visa.list') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View visa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.visa.add') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add visa</p>
                                    </a>
                                </li>
